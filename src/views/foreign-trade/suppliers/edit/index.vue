<template>
  <div class="edit-supplier">
    <el-card shadow="never">
      ...
      <el-form v-if="form" :model="form" :rules="rules" ref="formRef" label-width="120px" class="supplier-form">
  ...
  await formRef.value.validate(async (valid) => {
    if (valid) {
      ...
      try {
        ...
        const result = await foreignTradeStore.updateSupplier(id, { ...form })
        if (result) {
...
onMounted(async () => {
  ...
  if (supplier) {
    Object.assign(form, {
      ...
      alibaba_store: supplier.alibaba_store || '',
