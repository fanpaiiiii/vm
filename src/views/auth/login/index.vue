...
<script setup lang="ts">
  ...
  import { fetchTradeLogin } from '@/api/foreign-trade/auth'
  import type { LoginParams } from '@/api/foreign-trade/types'
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const loginRes = await fetchTradeLogin({
        username,
        password
      })

      // FastAPI 返回 {access_token, token_type, user}
